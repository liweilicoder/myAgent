    ...
    def __init__(
        ...
        **kwargs
        ...
        if provider == "modelscope":
            ...
            self.api_key = apiKey or os.getenv("OLLAMA_API_KEY")
            self.base_url = baseUrl or os.getenv("OLLAMA_API_URL")
            ...
            self.api_key = apiKey or os.getenv("VLLM_API_KEY")
            self.base_url = baseUrl or os.getenv("VLLM_API_URL")
            ...
            # 解析 MiniMax 的凭证
            self.api_key = apiKey or os.getenv("MINIMAX_API_KEY")
            self.base_url = baseUrl or os.getenv("MINIMAX_API_URL")
