...
from josie_agents.memory.manager import MemoryManager
        ...
        **metadata
        ...
        try:
            ...
            metadata.update({
                ...
                "timestamp":  metadata.get("timestamp") or datetime.now().strftime('%Y%m%d_%H%M%S'),
            })
        ...
        try:
            ...
            for i, memory in enumerate(results, 1):
                memory_type_label = {
                    ...
                    "semantic": "语义记忆",
                    "perceptual": "感知记忆"
                }.get(memory.memory_type, memory.memory_type) #get(key, defaultValue)
